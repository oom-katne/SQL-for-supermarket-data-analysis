...
LOAD DATA LOCAL INFILE 'C:\Users\katne\Desktop\SQL Project\SQL for supermarket data analysis\aisles.csv' INTO TABLE aisles
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'C:\Users\katne\Desktop\SQL Project\SQL for supermarket data analysis\departments.csv' INTO TABLE departments
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES;


LOAD DATA LOCAL INFILE 'C:\Users\katne\Desktop\SQL Project\SQL for supermarket data analysis\orders.csv' INTO TABLE orders
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES;

LOAD DATA LOCAL INFILE '/Users/mohamad/Desktop/SQL/Project/products.csv' INTO TABLE product
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'C:\Users\katne\Desktop\SQL Project\SQL for supermarket data analysis\order_products.csv' INTO TABLE order_product
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES;
